...
export default function WarehouseForm() {
  ...
  const onSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (validateForm()) {
      try {
        ...
        await SUPPORT_LOCATION_APIS.save("warehouse", {
          locationType: "warehouse",
          userId: user._id,
          ...submitData,
        });
        queryClient.invalidateQueries("support-location-warehouse");
  ...
  return (
    <Card className="mx-auto w-full border-none shadow-none">
      <CardContent>
        <form id="warehouse-form-id" onSubmit={onSubmit} className="space-y-8">
          {/* Current Situation */}
